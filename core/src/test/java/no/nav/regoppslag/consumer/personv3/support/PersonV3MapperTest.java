...
public class PersonV3MapperTest {
	...
	public void shouldMapSpraakKode() {
		...
		MatcherAssert.assertThat(mottakerTo.getSpraakKode(), is("NO"));

		person.setMaalform(createSpraak("AA"));
		mottakerTo = mapper.map(person, "");
		MatcherAssert.assertThat(mottakerTo.getSpraakKode(), is("AA"));
	}
	...
	public void mapPersonBostedadresseMedGateadresse() {
		...
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(GATENAVN + " " + HUSNR + HUSBOKSTAV));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPostnummer()), is(POSTNR));
	...
	public void mapPersonBostedadresseMedMatrikkeladresse() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(EIENDOMSNAVN));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPostnummer()), is(POSTNR));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPoststed()), is(POSTSTED));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getLand()), is(LAND));
	}
	...
	public void mapPersonBostedadresseMedPostboksadresse() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is("Postboks " + POSTBOKS));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPostnummer()), is(POSTNR));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPoststed()), is(POSTSTED));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getLand()), is(LAND));
	}
	...
	public void mapPersonPostadresse() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(NORSK_ADRESSELINJE1));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(NORSK_ADRESSELINJE2));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje3()), is(NORSK_ADRESSELINJE3));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPostnummer()), is(POSTNR));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPoststed()), is(POSTSTED));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getLand()), is(LAND));
	}
	...
	public void mapPersonPostadresseWhereAdresseLinje4HasPostnummer() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPostnummer()), is("0001"));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getPoststed()), is("OSLO"));
	...
	public void shouldMapToUtenlandskAdresseWhenLandIsNotNorway() {
		...
		Assert.assertTrue(mottaker.getMottaker().getMottakeradresse() instanceof UtenlandskPostadresse);
	}
	...
	public void mapPersonPostadresseMedMidlertidigAdresseUtland() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((UtenlandskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(UTLAND_ADRESSELINJE1));
		MatcherAssert.assertThat((((UtenlandskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(UTLAND_ADRESSELINJE2));
		MatcherAssert.assertThat((((UtenlandskPostadresse) mottaker.getMottakeradresse()).getAdresselinje3()), is(UTLAND_ADRESSELINJE3));
		MatcherAssert.assertThat((((UtenlandskPostadresse) mottaker.getMottakeradresse()).getLand()), is(LAND_UTLAND));
	}
	...
	public void mapPersonPostadresseMedMidlertidigGateAdresseMedCo() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(TILLEGGSADRESSETYPE_CO + " " + TILLEGGSADRESSE));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(GATENAVN + " " + HUSNR + HUSBOKSTAV));
	}
	...
	public void mapPersonPostadresseMedMidlertidigGateAdresseMedCoAdresse() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(CO_TILLEGGSADRESSE));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(GATENAVN + " " + HUSNR + HUSBOKSTAV));
	...
	public void mapPersonPostadresseMedMidlertidigGateAdresseMedV() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(TILLEGGSADRESSETYPE_V + " " + TILLEGGSADRESSE));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(GATENAVN + " " + HUSNR + HUSBOKSTAV));
	}
	...
	public void mapPersonPostadresseMedMidlertidigGateAdresseMedVAdresse() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(V_TILLEGGSADRESSE));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(GATENAVN + " " + HUSNR + HUSBOKSTAV));
	...
	public void mapPersonPostadresseMedMidlertidigMatrikkelAdresseMedCo() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(TILLEGGSADRESSETYPE_CO + " " + TILLEGGSADRESSE));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(EIENDOMSNAVN));
	}
	...
	public void mapPersonBostedAdresseMedMidlertidigPostboksAdresseMedCo() {
		...
		Mottaker mottaker = mottakerTo.getMottaker();
		MatcherAssert.assertThat(((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1(), is(TILLEGGSADRESSETYPE_CO + " " + TILLEGGSADRESSE));
		MatcherAssert.assertThat(((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2(), is("Postboks" + " " + POSTBOKS));
	}
	...
	public void shouldNotThrowIfMissingNotMissingAdresseLinje1ButMissingOtherAdresseAttributes() {
		...
		MatcherAssert.assertThat(norskPostadresse.getAdresselinje1(), is(NORSK_ADRESSELINJE1));
	}
