...
public class OrganisasjonV4MapperTest {
	...
	public void mapOrganisasjonSemistrukturertPostadresse() throws Exception {
		...
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje1()), is(SEMIADR1));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje2()), is(SEMIADR2));
		MatcherAssert.assertThat((((NorskPostadresse) mottaker.getMottakeradresse()).getAdresselinje3()), is(SEMIADR3));
