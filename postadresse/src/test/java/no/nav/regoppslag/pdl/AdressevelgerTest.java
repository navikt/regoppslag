...
import static no.nav.regoppslag.pdl.Adressevelger.velgGyldigAdresse;
...
class AdressevelgerTest {
	...
	void shouldReturnereTomOptionalWhenAdresselistenMangler() {
		assertThat(velgGyldigAdresse(null, TIDSPUNKT)).isEmpty();
	}
	...
	void shouldVelgeForsteGyldigePDLKontaktadresse() {
		...
		Optional<Kontaktadresse> resultat = velgGyldigAdresse(List.of(forste, andre), TIDSPUNKT);
	...
	void shouldPrioriterePDLKontaktadresseOverNyereFREGKontaktadresse() {
		...
		Optional<Kontaktadresse> resultat = velgGyldigAdresse(List.of(freg, pdl), TIDSPUNKT);
	...
	void shouldVelgeNyesteFREGKontaktadresseWhenPDLKontaktadresseMangler() {
		...
		Optional<Kontaktadresse> resultat = velgGyldigAdresse(List.of(eldre, nyere), TIDSPUNKT);
