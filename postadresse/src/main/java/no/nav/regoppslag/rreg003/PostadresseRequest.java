...
public class PostadresseRequest {
	...
	@Schema(example = "FOR", description = "Tema som hjemmel til å hente adresseinformasjon for identifikator. Eksempel: \"FOR\" (Foreldrepenger).", required = true, allowableValues = "DAG, FOR, PEN, FRI ....")
	private String tema;
}
