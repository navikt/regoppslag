...
import static no.nav.regoppslag.pdl.PDLAdresseUtil.getAlpha2Landkode;
import static no.nav.regoppslag.pdl.PDLAdresseUtil.normaliserAdresselinjer;
...
final class UtenlandskAdresseMapper {
	...
	static PostadresseTo mapUtenlandskAdresse(UtenlandskAdresse utenlandskAdresse, String coAdressenavn, AdresseKildeCode adresseKilde) {
		...
		List<String> adresselinjer = normaliserAdresselinjer(mapPotensielleAdresselinjer(
