...
final class NorskAdresseMapper {
	...
	static PostadresseTo mapVegadresse(Vegadresse vegadresse, String coAdressenavn, AdresseKildeCode adresseKilde) {
		List<String> adresselinjer = PDLAdresseUtil.normaliserAdresselinjer(prependWithCareOfIfMissing(coAdressenavn), vegadresse.mapAdresselinjeFromVegadresse());
	...
	static PostadresseTo mapMatrikkeladresse(Matrikkeladresse matrikkeladresse, AdresseKildeCode adresseKilde) {
		List<String> adresselinjer = PDLAdresseUtil.normaliserAdresselinjer(matrikkeladresse.getTilleggsnavn());
	...
	private static PostadresseTo mapPostadresseFrittFormat(Kontaktadresse kontaktadresse) {
		...
		List<String> adresselinjer = PDLAdresseUtil.normaliserAdresselinjer(
	...
	private static PostadresseTo mapPostboksadresse(Kontaktadresse kontaktadresse) {
		...
		List<String> adresselinjer = PDLAdresseUtil.normaliserAdresselinjer(postbokseier, mapPostboks(postboksadresse.getPostboks()));
