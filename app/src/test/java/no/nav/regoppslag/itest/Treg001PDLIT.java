...
public class Treg001PDLIT extends AbstractIT {
	...
	public void shouldGetKomplettBrevdataPerson() {
		...
		KompletterBrevdataResponse actualResponse = restTemplate.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_full_request.xml"), KompletterBrevdataResponse.class);
	...
	public void shouldGetKomplettBrevdataOrg() {
		...
		getPdlDkif(HttpStatus.OK.value(), "dkif/dkif-happy.json");
		KompletterBrevdataResponse actualResponse = restTemplate.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_full_request_orgv4.xml"), KompletterBrevdataResponse.class);
	...
	public void shouldNotMapBehandlendeEnhetWhenBerikIsFalse() {
		...
		postPdlGraphql(HttpStatus.OK.value(), "pdl/bosattadressemedconavn.json");
		getPdlDkif(HttpStatus.OK.value(), "dkif/dkif-happy.json");
		KompletterBrevdataResponse actualResponse = restTemplate.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_full_request_behandlende_enhet_8020.xml"), KompletterBrevdataResponse.class);
	...
	public void shouldThrowFunctionalExceptionFromOrgPlugin() {
		...
		HttpStatusCodeException e = assertThrows(HttpStatusCodeException.class, () ->
						restTemplate.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_request_orgv4.xml"), KompletterBrevdataResponse.class),
	...
	public void shouldThrowTechnicalIfPersonIsMissingAdresse() {
		...
		HttpClientErrorException e = assertThrows(HttpClientErrorException.class, () ->
						restTemplate.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_full_request.xml"), KompletterBrevdataResponse.class),
	...
	public void shouldThrowWhenPDLFailsFunctionalInvalidSecurityToken() {
		...
		getPdlDkif(HttpStatus.OK.value(), "dkif/dkif-happy.json");
		HttpStatusCodeException e = assertThrows(HttpStatusCodeException.class, () ->
						restTemplateNoHeader.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_full_request.xml"), KompletterBrevdataResponse.class),
				"Test did not throw exception");
	...
	public void shouldThrowFunctionalExceptionFromNorgPlugins() {
		...
		getPdlDkif(HttpStatus.OK.value(), "dkif/dkif-happy.json");
		HttpClientErrorException e = assertThrows(HttpClientErrorException.class, () ->
						restTemplate.postForObject(LOCAL_ENDPOINT_URL + RegisteroppslagRestController.REST + RegisteroppslagRestController.KOMPLETTER_BREVDATA_URI_PATH, createRequest("__files/treg001pdl/treg001_norg2_request.xml"), KompletterBrevdataResponse.class),
				"Test did not throw exception");
