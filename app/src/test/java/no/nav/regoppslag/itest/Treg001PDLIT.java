...
public class Treg001PDLIT extends AbstractIT {
	...
	public void shouldMapAndGetKomplettBrevdataForBostedsadresseWithNullGyldigFraOgMed() {
		...
		assertThat(actualResponse.getBrevdata()).isEqualTo(classpathToString("__files/treg001pdl/treg001pdl_bostedsadresse_null_gyldigFraOgMed.xml"));
	}
	...
	public void shouldReturnNotFoundIfPersonIsMissingAdresseInPdl() {
		...
		assertThat(e.getStatusCode()).isEqualTo(NOT_FOUND);
		assertThat(e.getResponseBodyAsString()).contains("Funksjonell feil: dokumenttypeId=123 feilmelding=Fant ikke bostedsadresse for personen i PDL");
	}
