...
public class PersonV3MapperTest {
    ...
    public void shouldThrowIfDodPersonWithoutAdress() throws Exception {
        ...
        doedsdato.setDoedsdato(createDoedsdato());
        person.setDoedsdato(doedsdato);
        assertThrows(UkjentAdressePersonErDoed.class,
                () -> mapper.map(person, ""), "Mottaker er registrert som død og har ugyldig postadresse. Adresse mangler adresselinje1, postnummer, poststed og land.");
    ...
    public void shouldThrowIfUtenPostnrAndLand() throws Exception {
        ...
        assertThrows(UkjentAdresseException.class,
                () -> mapper.map(person, ""), "Ugyldig postadresse. Adresse mangler adresselinje1, postnummer, poststed og land. GjeldenePostadresseType=POSTADRESSE");
    }
