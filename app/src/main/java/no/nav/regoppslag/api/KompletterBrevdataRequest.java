...
public class KompletterBrevdataRequest {
	...
	@ApiModelProperty(example = "000093", notes = "Benyttes for å hente tilknyttede Språkinfo fra Dokumentkatalogen.", required = true)
	...
	@ApiModelProperty(example = "FOR", notes = "Temaet som forsendelsen tilhører, for eksempel \"FOR\" (foreldrepenger).", allowableValues = "DAG, FOR, PEN, FRI ....")
	private String tema;
}
