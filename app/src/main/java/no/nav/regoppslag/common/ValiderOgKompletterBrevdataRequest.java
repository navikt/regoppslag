...
public class ValiderOgKompletterBrevdataRequest {
	...
	@ApiModelProperty(example = "I000003", notes = "Benyttes for å hente tilknyttede Språkinfo fra Dokumentkatalogen.")
	private String dokumentTypeId;
	@ApiModelProperty(example = exampleBrevdata, notes = "Brevdata fra felles mastermal. XML'en kan være utfylt med data eller ikke.")
