...
public class HentMottakerOgAdresseService {
    ...
    private final MappPDLResponse mappPDLResponse;
    ...
    public HentMottakerOgAdresseService(PersonV3Consumer personV3Consumer, PersonV3Mapper personV3Mapper,
                                        ...
                                        MappPDLResponse mappPDLResponse, AdresseMapper adresseMapper) {
    ...
    public HentMottakerOgAdresseResponse hentMottakerOgAdresseInfo(HentMottakerOgAdresseRequest request) throws RegOppslagFunctionalException, RegOppslagTechnicalException, RegOppslagSecurityException {
        ...
        try {
            ...
            HentMottakerOgAdresseResponse hentMottaker;
            if (PERSON.name().equals(request.getType())) {
                hentMottaker = mappPDLResponse.mapHentPerson(pdlGraphQLConsumer.hentPerson(request.getIdentifikator(), request.getTema()), SERVICE_CODE_TREG002);
                ...
                hentMottaker = HentMottakerOgAdresseResponse.builder()
