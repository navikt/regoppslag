...
public class RegisteroppslagRestController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "400", description = "Ugyldig input. Denne feilen vil returneres hvis det er feil i inputverdiene, eller om det mangler SAML token når mottakertype=PERSON", content = @Content),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "OK"),
			@ApiResponse(responseCode = "400", description = "Ugyldig input. Denne feilen vil returneres hvis det er feil i inputverdiene, eller om det mangler SAML token når type=PERSON", content = @Content),
			@ApiResponse(responseCode = "401", description = "Ingen tilgang til PersonV3", content = @Content),
