...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Request for å komplettere brevdata med registerdata")
public class KompletterBrevdataRequest {
	...
	@Schema(example = "000093", description = "Benyttes for å hente tilknyttede Språkinfo fra Dokumentkatalogen.", requiredMode = REQUIRED)
